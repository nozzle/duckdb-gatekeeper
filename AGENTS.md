...
- Update the `duckdb` submodule, Python package pin, build/version checks, fuzz image, and other engine-version references together. Keep source revisions and container digests pinned; do not replace them with floating references.
